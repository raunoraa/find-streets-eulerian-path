...
# Folder "input_files" already exists, only the folder itself and the md file inside it are tracked by Git.
LANES_GEOJSON_FILE_PATH = "input_files/Lane polygons.geojson"
INTERSECTIONS_GEOJSON_FILE_PATH = "input_files/Intersection polygons.geojson"
OSM_XML_FILE_PATH = "input_files/osm.xml"
...
# If the folder path is not changed, then the folder itself and the files inside are not tracked by Git.
